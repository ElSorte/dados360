...
#!perl
#line 29
    eval 'exec C:\Users\SAMSUNG\Documents\dados360\docs\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\SAMSUNG\Documents\dados360\docs\xampp\perl\bin\perl.exe';
